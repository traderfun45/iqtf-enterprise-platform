export type CotMarketData = { id:number; symbol:string; reportDate:string; openInterest:number; producerLong:number; producerShort:number; swapDealerLong:number; swapDealerShort:number; managedMoneyLong:number; managedMoneyShort:number; otherReportablesLong:number; otherReportablesShort:number; source:string; note?:string }
